...
Some of the toolkit components utilize ArcGIS Location Services which require an API key. Refer to the 'Get an access token' section of the [Get Started guide](https://developers.arcgis.com/java/get-started/#3-get-an-access-token) for more information. Help with how to set your API key can be found in the 

...
import com.esri.arcgisruntime.toolkit.examples.controller.ExamplesAppController;
...
public class ExamplesApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            scene.getStylesheets().add(String.valueOf(getClass().getResource("styles/app.css")));
            scene.getStylesheets().add(String.valueOf(getClass().getResource("styles/example.css")));

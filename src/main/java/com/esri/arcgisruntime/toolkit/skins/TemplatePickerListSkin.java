...
import com.esri.arcgisruntime.toolkit.TemplatePickerList;
...
public class TemplatePickerListSkin extends SkinBase<TemplatePickerList> {
  ...
  public TemplatePickerListSkin(TemplatePickerList control) {
    super(control);
